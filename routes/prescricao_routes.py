...
def init_prescricao_routes(prescricao_service: PrescricaoService):
    ...
    @prescricao_bp.route('/prescricoes/<int:id_prescricao>', methods=['GET'])
    ...
    @prescricao_bp.route('/prescricoes/<int:id_prescricao>', methods=['PUT'])
    ...
    @prescricao_bp.route('/prescricoes/<int:id_prescricao>', methods=['DELETE'])
