...
('123456', 'Dr. João Silva', '123.456.789-01', 15000.00),
('234567', 'Dra. Maria Oliveira', '234.567.890-12', 17000.00),
('345678', 'Dr. Pedro Santos', '345.678.901-23', 16000.00),
('456789', 'Dra. Ana Costa', '456.789.012-34', 15500.00),
('567890', 'Dr. Ricardo Mendes', '567.890.123-45', 18000.00);

INSERT INTO AgendaMedico (crm_medico, data, inicio_platao, fim_platao, duracao_slot_minutos) VALUES
('123456', '2025-01-10', '08:00', '14:00', 30),
('234567', '2025-01-11', '10:00', '18:00', 20),
('345678', '2025-01-12', '07:00', '13:00', 40),
('456789', '2025-01-13', '12:00', '20:00', 30),
('567890', '2025-01-14', '09:00', '17:00', 15);
...
('123456', 'Gripe', 'A', 150.00, '2025-01-10 09:00:00', 1),
('234567', 'Dor lombar', 'A', 220.00, '2025-01-11 10:30:00', 2),
('345678', 'Alergia', 'C', 180.00, '2025-01-12 08:00:00', 3),
('456789', 'Sinusite', 'A', 210.00, '2025-01-13 14:00:00', 4),
('567890', 'Enxaqueca', 'A', 250.00, '2025-01-14 11:00:00', 5);
...
('A', '123456', '2025-01-11', '2025-01-10', 1, 1),
('C', '234567', '2025-01-12', '2025-01-11', 2, 2),
('A', '345678', NULL, '2025-01-12', 3, 3),
('A', '456789', '2025-01-14', '2025-01-13', 4, 4),
('C', '567890', '2025-01-15', '2025-01-14', 5, 5);
...
('Curativo', 80.00, '123456', 1),
('Sutura simples', 150.00, '234567', 2),
('Nebulização', 60.00, '345678', 3),
('Remoção de pontos', 70.00, '456789', 4),
('Pequena drenagem', 200.00, '567890', 5);
...
(1, '123456', 'COREM001', 1, '2025-01-01', NULL, '2025-01-10'),
(2, '234567', 'COREM002', 2, '2025-01-02', '2025-01-08', '2025-01-09'),
(3, '345678', 'COREM003', 3, '2025-01-03', NULL, '2025-01-12'),
(4, '456789', 'COREM004', 4, '2025-01-04', NULL, '2025-01-11'),
(5, '567890', 'COREM005', 5, '2025-01-05', '2025-01-15', '2025-01-14');
...
('123456', '(21)90000-0001'),
('234567', '(31)90000-0002'),
('345678', '(41)90000-0003'),
('456789', '51)90000-0004'),
('567890', '(61)90000-0005');

INSERT INTO TelefoneEnfermeiro (corem_enfermeiro, numero_telefone) VALUES
('COREM001', '(27)98888-0001'),
('COREM002', '(47)98888-0002'),
('COREM003', '(85)98888-0003'),
('COREM004', '(92)98888-0004'),
('COREM005', '(98)98888-0005');
